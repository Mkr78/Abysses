...
<form action="./dateFiltre.php" method="POST">
<button title="Définir un nouveau compte à rebours" class="btn btn-sm" type="submit" id="reset" name="resetF" style="background:yellowGreen; color:white;">Reset</button>
